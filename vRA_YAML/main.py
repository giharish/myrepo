...
def handler(context, inputs):
    ...
    lcm_on = "on" # Set "on" to enable using vRSLCM or "off" to use local variables and replacing by "localsmtpPassword" & "localvraRefreshToken"
    localsmtpPassword = "XXXXXXXX" # paste your password
    localvraRefreshToken = "XXXXXXXX" # paste your vRA Token 
    
    ######## SMTP Configuration START #####################
    smtp_port = 465 
    smtp_server = "smtp.gmail.com" # FQDN for SMTP
    smtp_login = "giharish@gmail.com" # Login to access SMTP Server 
    sender_email = "giharish@gmail.com" # Email Address for Sender
    
    ######## vRA Configuration START #####################
    vraUrl = 'cava-n-81-246.eng.vmware.com' # vRA on-prem URL
    vraAlias = 'vRA Wexford' # vRA or vRAC Alias
    vraCloud = "on" # "on" for using vRAC Cloud | "off" for using vRA on-prem
